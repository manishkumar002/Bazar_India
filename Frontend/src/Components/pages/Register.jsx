...
const data = {name, email, password };
   function register(){
    ...
    console.log(data );
    fetch("http://127.0.0.1:8060/api/register", {
      method: "POST",
      headers: {
  ...
  return (
    ...
    <div class="card">
       ...
       <div class="email-login">
          ...
          <input type="text" placeholder="Enter Name" autocomplete="off" required  onChange={(e)=>setName(e.target.value)} value={name} />
          <label for="email"> <b>Email</b></label>
          <input type="text" placeholder="Enter Email" autocomplete="off" required  onChange={(e)=>setEmail(e.target.value)}  value={email}/>
          <label for="psw"><b>Password</b></label>
          <input type="password" placeholder="Enter Password" autocomplete="off"  required  onChange={(e)=>setPassword(e.target.value)} value={password} />
       </div>
       <button class="cta-btn" onClick={register}>Sign up</button>
