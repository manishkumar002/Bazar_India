...
export default function Login() {
 ...
 function onLoginPress() {
    ...
    fetch(" http://127.0.0.1:8060/api/login", {
      method: "POST",
      headers: {
  ...
  return (
    ...
    <div class="card">
       ...
       <p className="subtitle">Don't have an account? <button style={{ border: 'none' }}><Link to="/register">Sign Up</Link></button></p>
       ...
       <button class="cta-btn" onClick={onLoginPress}>Sign up</button> 
       <div>
       <button style={{ border: 'none',float:'right' }}><Link to="/send-link">Farget Password</Link></button>
       </div>
 </div>
 </div>
 <div className='col-sm-4'></div>
